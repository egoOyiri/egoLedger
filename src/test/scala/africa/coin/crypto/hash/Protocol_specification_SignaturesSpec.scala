...
import africa.coin.crypto.signature.ecc._
...
class Protocol_specification_SignaturesSpec extends FreeSpec {
  ...
  val secret = africa.coin.crypto.signature.encode.Hex.decode("9bdde8fb7d18f5a3cf7698ee307650c4b05c74c5896eca00fc8af4355d54db7")
